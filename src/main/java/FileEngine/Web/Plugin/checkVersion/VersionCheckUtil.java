...
import FileEngine.Web.Plugin.Plugin;
...
public class VersionCheckUtil {
    ...
    private static JSONObject getVersionInfo() throws IOException {
        String url = "https://cdn.jsdelivr.net/gh/XUANXUQAQ/File-Engine-Version/Plugins%20Repository/WebPluginVersion.json";
        String fileName = "WebPluginVersion.json";
        String savePath = "tmp";
        try {
            ...
            while (!downloadTasks.contains(url + new File(savePath, fileName).getAbsolutePath())) {
                if (System.currentTimeMillis() - start > 10000) {
                    throw new RuntimeException("获取插件Web更新信息失败");
                }
